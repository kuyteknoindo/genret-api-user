 ...
 * @param imageBase64 The base64 encoded reference image string (optional).
 * @param mimeType The MIME type of the reference image (optional).
 * @returns A promise that resolves to a base64 encoded image URL.
 */
export async function generateImage(apiKey: string, prompt: string, imageBase64?: string, mimeType?: string): Promise<string> {
    try {
